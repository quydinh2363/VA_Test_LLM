...
Đọc câu hỏi người dùng và TRẢ VỀ CHỈ MỘT DÒNG DUY NHẤT, KHÔNG GIẢI THÍCH hay text phụ nào khác.
...
- Chỉ in 1 DÒNG: ví dụ "ASK_DOC" hoặc "PAYLOAD:xss:10" hoặc "OTHER".
...
- "những câu hỏi có liên quan đến bảo mật khác" -> OTHER
